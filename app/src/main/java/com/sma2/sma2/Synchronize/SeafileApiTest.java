...
public class SeafileApiTest {
    ...
    public static String username = "me@example.com";
    public static String password = "asecret";
    ...
    public static void main(String[] args) {
        ...
        String repo_id = libraries.get(0).getId();
...
/*
        File file1=new File("/home/martin/Desktop/default.png");
        if(file1.isFile()){
          List<UploadFileRes> uploadFileResList=api.uploadFile(client,token,uploadLink_tmp,"/","",file1);
